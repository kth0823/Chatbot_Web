...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".write_btn").on("click", function() {
			...
			formObj.attr("action", "/board/FWwrite");
...
<body>
	...
	<div id="root">
		...
		<section id="container">
			<form name="writeForm" method="post" action="/board/FWwrite" enctype="multipart/form-data">
				<table id="writedata">
					<tbody>						
						<tr>
							<td><label for="">F/W 버전</label><br>								
								 <input type="text" id="Fw" name="Fw" class="chk" placeholder="F/W버전을 입력하세요." style="width: 98%;" />
								</td>
						</tr>
						<tr>
							<td><label for="">설명</label><br>								
								 <input type="text" id="Fcomment" name="Fcomment" class="chk" placeholder="F/W에 대한  설명을 하세요." style="width: 98%;" />
								</td>
						</tr>						
						<tr>
							<td id="fileIndex">
