...
App.Face={init:function(){$(".list_photo .link_thumb").on("click",App.Face.onclick_sample)},onclick_sample:function(e){$(".list_photo .on").removeClass("on");
	...
	$.post(
			{url:"https://dapi.kakao.com/v2/vision/text/ocr", 
				...
				//console.log(result1.result.key);
				//console.log(result1['result']);
				console.log(result);
				//console.log(Object.key(result1));
				console.log(result1.indexOf('recognition_words', 0));
				console.log(result1.indexOf('recognition_words', 1));				
			/*		for (key in result1) {
						//var test1=console.log(result[key.reuslt.recognition_words]);
						//console.log(result1[key[0]]);
						//console.log(result1.key[0]);
						console.log(result1.recognition_words);
						//console.log(result1.key[0].recognition_words);
						console.log(result1[0].recognition_words);
					} */
				for (var i=0;i<result1.length;i++){
					for (key in i) {
						console.log(result1[key][i]);
					}
				}
