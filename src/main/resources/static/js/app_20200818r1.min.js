...
App.Face={init:function(){$(".list_photo .link_thumb").on("click",App.Face.onclick_sample)},onclick_sample:function(e){$(".list_photo .on").removeClass("on");
	...
	function ImageFile(e){
		this.init(e)
		}$.extend(ImageFile.prototype,{init:function(e){this.elm=$(e);
	this.section=this.elm.data("section");
	this.elm.bind("change",this.on_change.bind(this))},on_change:function(e){var file=this.elm[0].files[0];
	if(!file)return;
	App.reset_url_input($("#"+this.section+"_url_input")[0]);
	this.load_image(file);
	App.run_api(this.section,file,null)},load_image:function(file){var sample_image=$("#"+this.section+"_sample_image");
	var reader=new FileReader;
