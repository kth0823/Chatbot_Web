...
App.Face={init:function(){$(".list_photo .link_thumb").on("click",App.Face.onclick_sample)},onclick_sample:function(e){$(".list_photo .on").removeClass("on");
	...
	if(recog_word.length==8){
		var region1=recog_word.slice(0, 1);
		console.log(region1);
		
		var region_no=recog_word.slice(1, 3);
		console.log(region_no);
		
		var bus_type=recog_word.slice(3, 4);
		console.log(bus_type);
	}
	
	if(recog_word.length==9){
		var region1=recog_word.slice(0, 2);
		console.log(region1);
		
		var region_no=recog_word.slice(2, 4);
		console.log(region_no);
		
		var bus_type=recog_word.slice(4, 5);
		console.log(bus_type);
	...
	var car_no=recog_word.slice(-4, recog_word.length);
	console.log(car_no);
	...
	var region_code=$('#car_regionid').val();
	var bus_typecode=$('#bus_typeid').val();
...
/*
	...
	img.onload=function(){sample_image.attr("org_width",this.width/12);sample_image.attr("org_height",this.height/12)}};reader.readAsDataURL(file)}});
