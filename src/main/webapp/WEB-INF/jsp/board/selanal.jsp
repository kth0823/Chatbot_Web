...
<title>에이텍티앤</title>
		...
		$(document).ready(function() {
			...
			$(".write_btn").on("click", function() {
				...
				formObj.attr("action", "/board/anal");
...
<div id="root">
		...
		<br>
		<br>
		<form name="writeForm" method="post" action="/board/anal" enctype="multipart/form-data">
		<label for="Start">*조회기간</label><br>
							<input type="text"
							...
							<input type="text"
								...
								<button id="show" class="write_btn btn btn-success" type="submit"> 조회 </button>
								<br>
		</form>
		</div>
</body>
